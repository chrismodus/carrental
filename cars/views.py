    ...
    def create(self, request, *args, **kwargs):
        ...
        if not available_cars:
            ...
            if not available_brand_cars:
                ...
                return JsonResponse(
                    {
                        "message": f"Car is not available. No other cars for brand {brand} are available either. Please try another brand.",
            ...
            return JsonResponse(
                {
                    "message": f"Car is not available; here are alternatives from the same brand.",
                    "car_names": car_names_for_brand
                }, 
                status=404)
